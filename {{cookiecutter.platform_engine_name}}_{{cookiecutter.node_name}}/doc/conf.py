...
from {{ cookiecutter.platform_engine_name }}_{{ cookiecutter.node_name }} import __version__
...
htmlhelp_basename = '{{ cookiecutter.platform_engine_name }}_{{ cookiecutter.node_name }}doc'
...
latex_documents = [
    (
        'index', '{{ cookiecutter.platform_engine_name }}_{{ cookiecutter.node_name }}.tex',
...
man_pages = [
    (
        'index',
        '{{ cookiecutter.platform_engine_name }}_{{ cookiecutter.node_name }}',
        '{{ cookiecutter.project_name }} Documentation',
        [author], 1
    ),
]
...
autoapi_modules = {
    '{{ cookiecutter.platform_engine_name }}_{{ cookiecutter.node_name }}': None
}
